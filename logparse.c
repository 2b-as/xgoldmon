...
struct rmsg_act s2_ltable[] =
  {
    ...
    { { 0x07, 0x0f, 0x01, 0x0f }, GSMTAP_RRC_SUB_SysInfoType5          , 24,  0, 22, make_rrc_downlink_msg },
    ...
    { { 0x07, 0x04, 0x01, 0x04 }, GSMTAP_RRC_SUB_SysInfoType5          , 24,  0, 22, make_rrc_downlink_msg },
    ...
    { { 0x07, 0x04, 0x01, 0x04 }, GSMTAP_RRC_SUB_SysInfoType15         , 24,  0, 22, make_rrc_downlink_msg },
