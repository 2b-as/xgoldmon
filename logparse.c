...
struct rmsg_act s2_ltable[] =
  {
    { { 0x04, 0x01, 0x05,   -1 }, GSMTAP_UMTS_CH_DCCH,  28,  0, 26, make_rrc_uplink_msg },
    { { 0x04, 0x01, 0x07,   -1 }, GSMTAP_UMTS_CH_DCCH,  24,  0, 22, make_rrc_uplink_msg },
    { { 0x07, 0x01, 0x3d,   -1 }, GSMTAP_UMTS_CH_PCCH,  20,  0, 18, make_rrc_downlink_msg },
    { { 0x08, 0x01, 0x52,   -1 }, GSMTAP_UMTS_CH_DCCH,  28,  0, 26, make_rrc_downlink_msg },
    { { 0x08, 0x01, 0x53,   -1 }, GSMTAP_UMTS_CH_DCCH,  24,  0, 22, make_rrc_downlink_msg },    
    { { 0x0d, 0x04, 0x0f,   -1 }, GSMTAP_CHANNEL_SDCCH, 10, 23,  0, make_gsml2_msg },
